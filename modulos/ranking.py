...
def mostrar_ranking():
    ...
    corriendo = True
    ruta_csv = "data/puntajes.csv"  # Archivo CSV con los datos del ranking
    ...
    while corriendo:
        ...
        # Título del ranking
        dibujar_texto("Ranking de Jugadores", FUENTE_TITULO, BLANCO, pantalla, ANCHO // 2, 50)
        ...
        for fila in datos:
            texto = " | ".join(fila)
            dibujar_texto(texto, FUENTE_S, BLANCO, pantalla, ANCHO // 2, y_offset)
            y_offset += 40
